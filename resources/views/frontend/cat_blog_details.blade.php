      ...
      <div class="row justify-content-center">
        <div class="col-xl-6 col-lg-8 col-md-10">
          <div class="breadcrumb__wrap__content">
            <h2 class="title">{{$blogCategory->blogcategory_name}}</h2>
        ...
        <div class="col-lg-8">
          ...
          <div class="standard__blog__post">
            ...
            <div class="standard__blog__content">
              ...
              <p>{!! Str::limit($blog->blog_description, 250) !!}
              </p>
          ...
          <aside class="blog__sidebar">
            ...
            <div class="widget">
              ...
              <ul class="sidebar__cat">
                ...
                <li class="sidebar__cat__item"><a href="{{route('category.blogs', $cat->id)}}">{{$cat->blogcategory_name}} </a></li>
                @endforeach
